...
// Opacity is kept low so it reads as atmosphere, not content — the narrative
// text remains the visual anchor.
...
// kind of plain-English input ArchiVox accepts.
...
//   2. BlueprintBackground — animated architectural floor plan SVG
...
export function HeroSection({ className }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      {/* Layer 2 — animated architectural blueprint */}
      <BlueprintBackground reduce={reduce} />

      {/* Layer 3 — cursor-follow ambient glow */}
      {!reduce && (
        <div
          aria-hidden
